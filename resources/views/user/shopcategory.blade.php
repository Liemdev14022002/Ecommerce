...
@section('title')
<title>{{ isset($category) ? $category->category_name : 'Sản phẩm theo danh mục' }}</title>
@endsection
...
<section class="shop spad">
    <div class="container">
        ...
        <a href="{{route('user.singleproduct',[$product->id,$product->slug])}}" class="see-more">See More</a>
    </div>
</div>
                    @endforeach
