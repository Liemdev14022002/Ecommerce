                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg">
                                <img src="{{ asset($allproduct->product_img) }}" alt="{{ $allproduct->product_name }}">
                            ...
                            <a href="{{route('user.singleproduct',[$allproduct->id,$allproduct->slug])}}" class="see-more">See More</a>
                        </div>
                    </div>
                    @endforeach                 
                </div>
